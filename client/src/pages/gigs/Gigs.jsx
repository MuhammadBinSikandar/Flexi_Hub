...
function Gigs() {
  ...
  const { isLoading, error, data, refetch } = useQuery({
    ...
    queryFn: () => {
      ...
      let url = `/gigs${search}`; // This keeps any existing search params
      ...
      if (queryString) {
        // If search is empty, use '?', otherwise use '&'
  ...
  return (
    <div className="gigs">
      <div className="container">
        <span className="breadcrumbs">FlexiHub {">"} Graphics & Design {">"}</span>
        <h1>AI Artists</h1>
        <p>
          Explore the boundaries of art and technology with FlexiHub's AI artists
        </p>
        <div className="menu">
          <div className="left">
            <span>Budget</span>
